class ForestPacksView {
    ...
    render() {
        ...
        main.innerHTML = `
            ...
            <div class="sm:min-h-96 !bg-no-repeat !bg-cover !bg-center" style="background: url(/img/forest-hero-bg.png)">
                <div class="text-[var(--screen-bg)] text-center sm:my-16 mt-16">
                    <img src="/img/icon/ic-tree.svg" alt="Forest Img" width="82" class="mx-auto" />
                    <h1 class="font-semibold text-4xl">Forest</h1>
                </div>
            ...
            <section class="relative">
                <div class="max-w-7xl px-4 mx-auto sm:py-20 pt-52 pb-20">
                    ...
                    <img src="/img/tree-img.png" alt="Forest Img" class="absolute bottom-0 left-0 -z-10" />
                </div>
            </section>
    ...
    renderPackCards() {
        const packData = [
            ...
            // Add more forest packs as needed
        ];
...
export default ForestPacksView;