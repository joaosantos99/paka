class MountainPacksView {
    ...
    render() {
        ...
        main.innerHTML = `
            ...
            <div class="sm:min-h-96 !bg-no-repeat !bg-cover !bg-center" style="background: url(/img/mountain-hero-bg.png)">
                <div class="text-[var(--screen-bg)] text-center sm:my-16 mt-16">
                    <img src="/img/icon/ic-mountain.svg" alt="Mountain Img" width="82" class="mx-auto" />
                    <h1 class="font-semibold text-4xl">Mountain</h1>
                </div>
            ...
            <section class="relative">
                <div class="max-w-7xl px-4 mx-auto sm:py-20 pt-52 pb-20">
                    ...
                    <img src="/img/mountain-img-light.png" alt="Mountain Img" class="absolute bottom-0 left-0 -z-10" />
                </div>
            </section>
        ...
        const packData = [
            {
                ...
                icons: ['mountain'],
                title: 'Sanctuary of the Annapurnas',
                date: '11 to 15 April',
                price: '1760€'
            },
            {
            ...
            },
            {
                ...
                icons: ['mountain', 'tree'],
                title: 'Meteora and the Land of the Gods',
                date: '11 to 15 April',
                price: '1760€'
            },
            {
                ...
                title: 'Mongolian Exploration',
                date: '11 to 15 April',
                price: '1760€'
            }
            // Add more mountain packs as needed
        ];
...
document.addEventListener('DOMContentLoaded', () => {
    new MountainPacksView();
});

export default MountainPacksView;